...
Не использовать без прямой команды пользователя:
...
- декоративную типографику, которая делает обложку похожей на рекламу тату-студии.

Предпочтение отдавать чистой, современной, выразительной типографике, которая соответствует конкретному референсу и нише.
...
- [ ] не используется случайная tattoo-style типографика;
